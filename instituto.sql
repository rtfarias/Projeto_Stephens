...
--
-- Host: localhost:3306
-- Generation Time: Jul 27, 2017 at 07:56 PM
...
CREATE TABLE `clientes` (
  ...
  `pontos_de_fidelidade` int(11) DEFAULT NULL,
...
INSERT INTO `clientes` (`id`, `thumbnail_principal`, `meta_keywords`, `meta_descricao`, `slug`, `nome`, `cpf`, `email`, `telefone`, `udid`, `celular`, `cep`, `endereco`, `numero`, `complemento`, `pontos_de_fidelidade`, `estado`, `cidade`) VALUES
(1, 'thumb_1501006636-attachment-3911773676235383381iPadPro_U00281_U0029 (1).jpg', NULL, NULL, '', 'Lorem Ipsum', '9032429349', 'murilo@hotmail.com', '345346345', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, '', NULL, NULL, '', 'Roberto dos Santos', '023.323.232-32', 'roberto@teste.com.br', '(54)2523-4234', '', '', '95020-360', 'Rua Ernesto Alves', '2008', 'apto 22', 0, 1, 1);
...
INSERT INTO `consultas` (`id`, `thumbnail_principal`, `meta_keywords`, `meta_descricao`, `slug`, `titulo`, `id_cliente`, `datahorario`, `aceito`, `justificativa`, `tipo`, `descricao`, `clinica`) VALUES
(1, NULL, NULL, NULL, '', 'Consulta Teste', 2, '0000-00-00 00:00:00', 0, '', 1, '', 2),
(2, NULL, NULL, NULL, '', '', 1, '0000-00-00 00:00:00', 0, '', 1, '', 2);

-- --------------------------------------------------------

--
-- Table structure for table `consultas_imagens`
--

CREATE TABLE `consultas_imagens` (
  `id` int(11) NOT NULL,
  `thumbnail_principal` varchar(255) DEFAULT NULL,
...
(4, 'Nome', 'nome', '', 'I', 3, 1, 1, 0),
(5, 'Cpf', 'cpf', '', 'I', 3, 1, 1, 1),
(6, 'E-mail', 'email', '', 'I', 3, 1, 1, 2),
(7, 'Telefone', 'telefone', '', 'I', 3, 1, 0, 3),
(8, 'Udid', 'udid', '', 'I', 3, 0, 0, 0),
(9, 'Titulo', 'titulo', '', 'I', 4, 0, 0, 1),
(10, 'Celular', 'celular', '', 'I', 3, 0, 0, 4),
(11, 'CEP', 'cep', '', 'I', 3, 0, 0, 5),
(12, 'Endereço', 'endereco', '', 'I', 3, 0, 0, 6),
(13, 'Número', 'numero', '', 'I', 3, 0, 0, 7),
(14, 'Complemento', 'complemento', '', 'I', 3, 0, 0, 8),
(17, 'Pontos de Fidelidade', 'pontos_de_fidelidade', '', 'INT', 3, 0, 0, 0),
(18, 'estado', 'estado', '', 'I', 5, 0, 0, 0),
(19, 'sigla', 'sigla', '', 'I', 5, 0, 0, 0),
(20, 'cidade', 'cidade', '', 'I', 6, 1, 1, 0),
(22, 'Data/Horario', 'datahorario', '', 'DT', 4, 1, 1, 3),
(23, 'Aceito', 'aceito', '', 'S', 4, 0, 0, 5),
(24, 'Justificativa', 'justificativa', '', 'T', 4, 0, 1, 6),
(25, 'Nome', 'nome', '', 'I', 7, 1, 1, 0),
(26, 'Descrição', 'descricao', '', 'T', 4, 1, 0, 4),
(27, 'Clínica', 'clinica', '', 'SI', 4, 1, 1, 2);
...
(1, 4, 3, 4, 'id_cliente', 'Cliente', 0, 1),
(2, 6, 5, 19, 'estado', 'estado', 0, 0),
(3, 3, 5, 19, 'estado', 'Estados', 9, 1),
(4, 3, 6, 20, 'cidade', 'Cidades', 10, 1),
(5, 4, 7, 25, 'tipo', 'Tipo', 8, 1);
...
(3, 'Gerenciamento de Clientes', 'ion-person-stalker', 0, 1, 'Cliente', 1, 'gerenciamento-de-clientes', 'cliente', 'clientes', 1, 0, 'clientes'),
(4, 'Consultas', 'ion-calendar', 0, 1, 'Consultas', 1, 'consultas', 'consulta', 'consultas', 0, 0, 'consultas'),
(5, 'Estados', 'fa-circle-o', 0, 0, 'Estados', 3, 'estados', 'estado', 'estados', 0, 0, 'estados'),
(6, 'Cidades', 'fa-circle-o', 0, 0, 'Cidades', 3, 'cidades', 'cidade', 'cidades', 0, 0, 'cidades'),
(7, 'Tipos de Tratamento', 'fa-circle-o', 0, 1, 'Tipos', 1, 'tipos', 'tipo', 'tipos', 1, 0, 'tipos');
...
(1, 1, '2017-07-21 21:14:49', '2017-07-21 21:14:49'),
(2, 3, '2017-07-24 21:12:40', '2017-07-24 21:12:40'),
(3, 2, '2017-07-20 21:36:06', '2017-07-20 21:36:06'),
(3, 3, '2017-07-24 21:23:09', '2017-07-24 21:23:09'),
(5, 3, '2017-07-25 20:13:28', '2017-07-25 20:13:28'),
(6, 3, '2017-07-26 00:33:31', '2017-07-26 00:33:31'),
(7, 3, '2017-07-27 17:45:54', '2017-07-27 17:45:54'),
...
INSERT INTO `sis_users` (`id`, `email`, `cnpj`, `password`, `permissions`, `last_login`, `first_name`, `last_name`, `created_at`, `updated_at`, `receber_notificacoes`, `thumbnail_principal`, `id_condomino`, `id_criador`, `udid`, `latitude`, `longitude`, `telefone`, `telefone2`, `celular`, `descricao`, `endereco`, `estado`, `cidade`, `cep`, `numero`, `complemento`, `bairro`, `hora_inicio_manha`, `hora_fim_manha`, `hora_inicio_tarde`, `hora_fim_tarde`, `hora_inicio_noite`, `hora_fim_noite`) VALUES
(1, 'ricardo@duostudio.com.br', '', '$2y$10$O.COyEoYXx5mjNSIcEZnYeQ.VqHMKZqnQHpSVXsWXO0H2tQTbIr42', NULL, '2017-07-27 20:54:00', 'Ricardo Farias', 'Tronca', '2017-02-21 05:00:34', '2017-03-20 17:31:00', 0, 'thumb_1500647570-foto2.png', NULL, NULL, NULL, NULL, NULL, '(54)9999-9999', NULL, NULL, NULL, 'sdfgsd', 0, 0, NULL, NULL, NULL, NULL, '12:00:00', '00:00:00', '00:00:00', '00:00:00', '15:30:00', '17:00:00'),
(2, 'caxias@duostudio.com.br', '', '$2y$10$pIFh6Q1vUUDlTQ6E82JpLO1W9/q/WDlpuiNr1MpVFGOLoVVVDscXC', NULL, '2017-07-24 21:13:07', 'Clinica Caxias do Sul', NULL, '2017-07-24 18:12:40', '2017-07-24 18:12:40', 0, NULL, NULL, NULL, NULL, NULL, NULL, '(54)6545-6376', NULL, NULL, NULL, 'Rua José Aloysio Brugger', 0, 0, NULL, NULL, NULL, NULL, '09:00:00', '12:00:00', '13:30:00', '18:00:00', '00:00:00', '00:00:00'),
(5, 'floripa@duostudio.com.br', '02.433.485/0999-02', '$2y$10$qPsjqhmTOfnV9AknxbejpuhXXtn0sFh1ldHnfnY6rifqos7.6WSEu', NULL, '2017-07-24 21:42:42', 'Clínica Floripa', NULL, '2017-07-24 18:30:01', '2017-07-24 18:30:01', 0, '', NULL, NULL, NULL, '-27.596640940731803', '-48.54553556242672', '(54)3535-3535', '', '', 'Clinica odontologica no centro de Florianópolis. Bla blalbal.', 'Rua Anita Garibaldi', 3, 1, '88020-120', '128', '', 'Centro', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00'),
(6, 'mauricio@duostudio.com.br', '18.855.946/0001-03', '$2y$10$e0cddwM6tFo6FqUE8wlehe6dveBoABmyHwVw9N98S2b85j/G4NAIW', NULL, NULL, 'Duo Studio', NULL, '2017-07-25 21:32:15', '2017-07-25 21:32:15', 0, '', NULL, NULL, NULL, '-29.1698598', '-51.188655100000005', '(54)3030-0070', '', '', 'a duo e um studio de interacao onde criamos projetos mobile com enfase no design inovador', 'Rua Feijó Júnior', 1, 1, '95034-160', '953', '', 'São Pelegrino', '08:00:00', '12:00:00', '13:30:00', '18:00:00', '00:00:00', '00:00:00'),
(7, 'caxias2@duostudio.com.br', '02.333.345/5555-01', '$2y$10$q6x8bOpB2EAkR3ZVTBMBn.nH1jyW27g7Ncy2g6TC7cFnyvd9TcVJm', NULL, '2017-07-27 17:46:13', 'Clinica Caxias 2', NULL, '2017-07-27 14:45:54', '2017-07-27 14:45:54', 0, NULL, NULL, NULL, NULL, '-29.163994449651995', '-51.17134619864203', '(54)5454-5454', '', '(54)99999-9999', 'skdlfjlaskjflasd', 'Rua Ernesto Alves', 1, 1, '95020-360', '123', '', 'Lurdes', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00', '00:00:00');
...
INSERT INTO `tipos` (`id`, `thumbnail_principal`, `meta_keywords`, `meta_descricao`, `slug`, `nome`) VALUES
(1, '', NULL, NULL, '', 'Estética Facial'),
(2, '', NULL, NULL, '', 'Clínica'),
(3, '', NULL, NULL, '', 'Implantes'),
(4, '', NULL, NULL, '', 'Estética Dental'),
(5, '', NULL, NULL, '', 'Ortodontia');

-- --------------------------------------------------------

--
-- Table structure for table `tipos_imagens`
--

CREATE TABLE `tipos_imagens` (
  `id` int(11) NOT NULL,
  `thumbnail_principal` varchar(255) DEFAULT NULL,
...
ALTER TABLE `consultas`
  ...
  ADD KEY `clinica` (`clinica`) USING BTREE;

--
-- Indexes for table `consultas_imagens`
--
ALTER TABLE `consultas_imagens`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tipos_imagens`
--
ALTER TABLE `tipos_imagens`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `consultas`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `consultas_imagens`
--
ALTER TABLE `consultas_imagens`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tipos_imagens`
--
ALTER TABLE `tipos_imagens`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cidades`
  ADD CONSTRAINT `fk_estado` FOREIGN KEY (`estado`) REFERENCES `estados` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `consultas`
  ...
  ADD CONSTRAINT `consultas_ibfk_2` FOREIGN KEY (`clinica`) REFERENCES `sis_users` (`id`);
