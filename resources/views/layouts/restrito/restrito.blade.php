...
<head>
	...
	<link rel="stylesheet" href="{{ url('css/admin/style-restrito.css') }}">
...
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<div class="wrapper">
		...
		<header class="main-header">
			@include('layouts/restrito/notification')
		</header>

		<!-- =============================================== -->

		<!-- Left side column. contains the sidebar -->
		@include('layouts/restrito/left-sidebar')
		<!-- =============================================== -->
		...
		<footer class="main-footer">
			...
			reserved. Template Restrito -->
		</footer>

		<!-- Control Sidebar -->
		@include('layouts/restrito/control-sidebar')
		<!-- /.control-sidebar -->
