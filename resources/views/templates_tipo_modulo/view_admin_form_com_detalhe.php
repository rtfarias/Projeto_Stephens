			...
			<div class="col-lg-12">
				<div class="box">
										...
										<?php if(get_class($field) == 'App\CampoModulo'){ ?>
											...
											<div class="form-group">
												...
												<?php if($field->tipo_campo == 'INT'){ ?>
													<div class="col-md-7">
														<input id="<?php echo $field->nome; ?>" <?php echo ($field->required) ? 'required' : ''; ?> type="number" step="1" class="form-control" value="<?php echo (isset($<ITEM_MODULO>)) ? $<ITEM_MODULO>->$campo : $field->valor_padrao; ?>" name="<?php echo $field->nome; ?>" />
													</div>
												<?php } ?>
												...
												<?php if($field->tipo_campo == 'DT'){ ?>
													<div class="col-md-7">
														<input id="<?php echo $field->nome; ?>" <?php echo ($field->required) ? 'required' : ''; ?> type="datetime-local" class="form-control" value="<?php echo (isset($<ITEM_MODULO>)) ? date_format(date_create($<ITEM_MODULO>->$campo), 'd/m/Y H:i') : $field->valor_padrao; ?>" name="<?php echo $field->nome; ?>" />
													</div>
												<?php } ?>
												<?php if($field->tipo_campo == 'TIME'){ ?>
													<div class="col-md-7">
														<input id="<?php echo $field->nome; ?>" <?php echo ($field->required) ? 'required' : ''; ?> type="time" class="form-control" value="<?php echo (isset($<ITEM_MODULO>)) ? $<ITEM_MODULO>->$campo : $field->valor_padrao; ?>" name="<?php echo $field->nome; ?>" />
													</div>
												<?php } ?>
												...
												<div class="col-md-7">
													<select id="<?php echo $field->nome; ?>" required class="form-control select2" name="<?php echo $field->nome; ?>">
														...
														<?php foreach ($$nomeVariavel as $option): ?>
															...
															<option <?php echo (isset($<ITEM_MODULO>) && $<ITEM_MODULO>->$campo == $option->id) ? 'selected' : ''; ?> value="<?php echo $option->id; ?>"><?php echo $option->$campoNome; ?></option>
														<?php endforeach; ?>
													</select>
												</div>
											</div>
					...
					<div class="box-footer">
						<?php if(isset($<ITEM_MODULO>) && $current_role->hasAccess($current_module->nome_tabela.'.update') || !isset($<ITEM_MODULO>) && $current_role->hasAccess($current_module->nome_tabela.'.create')){ ?>
