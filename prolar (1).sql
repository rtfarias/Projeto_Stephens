...
--
-- Host: localhost:3306
-- Generation Time: 26-Jun-2018 às 02:03
...
--
-- Estrutura da tabela `cidades_imagens`
--
...
INSERT INTO `destinos` (`id`, `thumbnail_principal`, `meta_keywords`, `meta_descricao`, `slug`, `cidade`, `estado`, `pais`, `continente`) VALUES
(1, NULL, NULL, NULL, '', 'Caxias do Sul', 'Rio Grande do Sul', 'Brasil', 'América do Sul');

-- --------------------------------------------------------

--
-- Estrutura da tabela `destinos_imagens`
--

CREATE TABLE `destinos_imagens` (
  `id` int(11) NOT NULL,
  `thumbnail_principal` varchar(255) DEFAULT NULL,
...
--
-- Estrutura da tabela `fornecedores_categorias`
--
...
--
-- Extraindo dados da tabela `fornecedores_categorias`
--
...
--
-- Estrutura da tabela `sis_activations`
--
...
--
-- Extraindo dados da tabela `sis_activations`
--
...
--
-- Estrutura da tabela `sis_basic_info`
--
...
--
-- Extraindo dados da tabela `sis_basic_info`
--
...
--
-- Estrutura da tabela `sis_campo_modulo`
--
...
--
-- Extraindo dados da tabela `sis_campo_modulo`
--
...
(126, 'Cidade', 'cidade', '', 'I', 25, 1, 1, 0),
(127, 'Estado', 'estado', '', 'I', 25, 1, 1, 0),
(128, 'País', 'pais', '', 'I', 25, 1, 1, 0),
(129, 'Continente', 'continente', '', 'I', 25, 1, 1, 0);

-- --------------------------------------------------------

--
-- Estrutura da tabela `sis_fk_modulo`
--
...
--
-- Extraindo dados da tabela `sis_fk_modulo`
--
...
--
-- Estrutura da tabela `sis_migrations`
--
...
(25, 'Destinos', 'fa-circle-o', 0, 1, 'Destinos', 1, 'destinos', 'destinos', 'destinos', 0, 1, 'destinos');

-- --------------------------------------------------------

--
-- Estrutura da tabela `sis_password_resets`
--
...
--
-- Extraindo dados da tabela `sis_password_resets`
--
...
--
-- Estrutura da tabela `sis_permissions`
--
...
--
-- Estrutura da tabela `sis_persistences`
--
...
--
-- Extraindo dados da tabela `sis_persistences`
--
...
(428, 1, 'qoxewEF3UikDWxQFDJa6nnR9OD0Id1oU', NULL, NULL),
(429, 1, 'TB5dloCcjeJKJhIaDLvu2cpLy9f411y5', NULL, NULL),
(430, 1, 'SYRrKGbLdRLKdKndhgCelnuc75f5LUkD', NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `sis_reminders`
--
...
--
-- Estrutura da tabela `sis_role_users`
--
...
--
-- Extraindo dados da tabela `sis_role_users`
--
...
--
-- Estrutura da tabela `sis_throttle`
--
...
--
-- Extraindo dados da tabela `sis_throttle`
--
...
(135, NULL, 'ip', '::1', NULL, NULL),
(136, 1, 'user', NULL, NULL, NULL),
(137, NULL, 'global', NULL, NULL, NULL),
(138, NULL, 'ip', '::1', NULL, NULL),
(139, 1, 'user', NULL, NULL, NULL),
(140, NULL, 'global', NULL, NULL, NULL),
(141, NULL, 'ip', '::1', NULL, NULL),
(142, 1, 'user', NULL, NULL, NULL),
(143, NULL, 'global', NULL, NULL, NULL),
(144, NULL, 'ip', '::1', NULL, NULL),
(145, 1, 'user', NULL, NULL, NULL),
(146, NULL, 'global', NULL, NULL, NULL),
(147, NULL, 'ip', '::1', NULL, NULL),
(148, 1, 'user', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estrutura da tabela `sis_tipos_modulo`
--
...
--
-- Extraindo dados da tabela `sis_tipos_modulo`
--
...
(1, 'admin@admin.com.br', '00.000.000/0000-00', '$2y$10$E3joI62VBhjAaC9xSM6FoOwIOOrGNk1S6cuhdMo/jQp4zERWaTMYG', NULL, 'admin', '2018-06-26 04:51:34', 'admin', '', '2017-02-21 05:00:34', '2018-06-26 01:51:34', 0, 'thumb_1526505279-Stephen.png', NULL, NULL, NULL, '-15.753151', '-47.880227200000036', '(54)9999-9999', '', '', '', 'Rua Ernesto Alves', 23, 1, '95020-360', '123456', '', 'Lurdes', '12:00:00', '00:00:00', '00:00:00', '00:00:00', '15:30:00', '17:00:00');

-- --------------------------------------------------------

--
-- Estrutura da tabela `solicitacoes_fornecedores`
--
...
--
-- Extraindo dados da tabela `solicitacoes_fornecedores`
--
...
INSERT INTO `usuarios` (`id`, `thumbnail_principal`, `meta_keywords`, `meta_descricao`, `slug`, `nome`, `telefone`, `cep`, `endereco`, `pais`, `estado`, `cidade`, `cpf`, `email`, `senha`) VALUES
(2, '', NULL, NULL, '', 'Mariana Ruaro Vigano', '(54)5544-5545', '45545-656', 'Teste', 'Teste', 'Teste', 'Teste', '555.555.555-55', 'teste@teste.com', '123123');
...
--
-- Indexes for table `destinos_imagens`
--
ALTER TABLE `destinos_imagens`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `destinos_imagens`
--
ALTER TABLE `destinos_imagens`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
